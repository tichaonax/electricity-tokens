if (!self.define) {
  ...
  self.define = (a, n) => {
    ...
    let r = {};
    const c = (s) => t(s, i),
      u = { module: { uri: i }, exports: r, require: c };
    e[i] = Promise.all(a.map((s) => u[s] || c(s))).then((s) => (n(...s), r));
  };
}
define(['./workbox-14aa2a4a'], function (s) {
  'use strict';
  (importScripts(),
    self.skipWaiting(),
    s.clientsClaim(),
    s.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: '61a42dc7e48986423c3c30c1ce1abbb4',
        },
        {
          url: '/_next/static/chunks/1684-2e692b19a9fbc935.js',
          revision: 'sEr3moFuFt8G7X_dEn23Q',
        },
        {
        ...
        {
          url: '/_next/static/chunks/app/dashboard/admin/users/%5Bid%5D/edit/page-c581a579836ff8af.js',
          revision: 'sEr3moFuFt8G7X_dEn23Q',
        },
        {
        ...
        {
          url: '/_next/static/chunks/app/dashboard/admin/users/page-ef38a9840b4b16fb.js',
          revision: 'sEr3moFuFt8G7X_dEn23Q',
        },
        {
        ...
        {
          url: '/_next/static/chunks/app/dashboard/contributions/page-95ed3422704def39.js',
          revision: 'sEr3moFuFt8G7X_dEn23Q',
        },
        {
        ...
        {
          url: '/_next/static/chunks/app/dashboard/meter-readings/page-eb6b634d0180678d.js',
          revision: 'sEr3moFuFt8G7X_dEn23Q',
        },
        {
          url: '/_next/static/chunks/app/dashboard/page-a5a1d96d6dbede5a.js',
          revision: 'sEr3moFuFt8G7X_dEn23Q',
        },
        {
          url: '/_next/static/chunks/app/dashboard/personal/page-79d526f4f2265ee8.js',
          revision: 'sEr3moFuFt8G7X_dEn23Q',
        },
        {
        ...
        {
          url: '/_next/static/sEr3moFuFt8G7X_dEn23Q/_buildManifest.js',
          revision: '0bd6b8a5346f1f5f773eeae93b1da0ca',
        },
        {
          url: '/_next/static/sEr3moFuFt8G7X_dEn23Q/_ssgManifest.js',

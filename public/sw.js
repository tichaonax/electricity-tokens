if (!self.define) {
  ...
  self.define = (i, t) => {
    ...
    e[n] = Promise.all(i.map((a) => u[a] || r(a))).then((a) => (t(...a), c));
  };
}
    ...
    a.precacheAndRoute(
      [
        ...
        },
        {
          ...
          revision: '5f46cb8b19ba7c5c3c214b6072cdcb1d',
        },
        {
          url: '/_next/static/4Vb6KVf0G7S3haSO_Y0zS/_buildManifest.js',
          revision: 'b67625ef962e34129b21733b5ffb007b',
        },
        {
          url: '/_next/static/4Vb6KVf0G7S3haSO_Y0zS/_ssgManifest.js',
          revision: 'b6652df95db52feb4daf4eca35380933',
        },
        {
          url: '/_next/static/chunks/1684-2e692b19a9fbc935.js',
          revision: '4Vb6KVf0G7S3haSO_Y0zS',
        },
        {

...
export function DashboardClient() {
  ...
  useEffect(() => {
    // Only redirect if status is definitively 'unauthenticated'
    // Do NOT redirect while status is 'loading' - wait for session to load
            ...
            return (
              <div className="flex flex-col lg:flex-row gap-6">
                ...
                <div className="flex-1 lg:pl-3">
                  ...
                  {canViewProgressive && !canViewBalance && canViewMaxDaily && (
                      ...
                      <dl>
                        ...
                        <dd className="text-lg font-medium text-gray-900 dark:text-gray-100">
                          {loadingStats ? (
                            ...
                            quickStats?.totalTokensUsed.toLocaleString() || '0'
                          )}
                        </dd>
                      </dl>
                    </div>

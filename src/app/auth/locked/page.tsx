    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <Card>
          <CardHeader className="text-center">
            ...
            <CardTitle className="text-red-800">Account Access Restricted</CardTitle>
            <CardDescription>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <h3 className="font-medium text-blue-800 mb-2">What can I do?</h3>
      ...
      <div className="mt-8 text-center">
        <p className="text-xs text-gray-500">
          ...
          <a href="mailto:support@electricitytokens.com" className="text-blue-600 hover:text-blue-500">

            ...
            <div className="flex flex-wrap items-center gap-4">
              <div className="flex items-center gap-2">
                ...
                <input
                  ...
                  className="px-3 py-1 border border-slate-300 rounded-md text-sm focus:outline-none focus:ring-2 focus:ring-green-500 dark:border-slate-600 dark:bg-slate-700 dark:text-slate-100"
                />
              ...
              <div className="flex gap-2">
                ...
                <Button type="button" variant="outline" size="sm" onClick={setCurrentYear}>
                  This Year
                </Button>
